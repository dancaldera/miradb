...
import type { DatabaseConfig, DatabaseConnection, QueryResult, SQLiteDatabase } from './types.js';
...
export class SQLiteConnection implements DatabaseConnection {
  ...
  async connect(): Promise<void> {
    try {
      this.db = new Database(this.config.connectionString, { fileMustExist: false });
