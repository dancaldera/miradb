...
function generateCSV(data: DataRow[], columns: ColumnInfo[], includeHeaders: boolean): string {
  const lines: string[] = [];
...
function generateJSON(data: DataRow[], columns: ColumnInfo[], includeHeaders: boolean): string {
  if (includeHeaders) {
